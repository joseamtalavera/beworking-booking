...
} from "./chunk-CQOBHVCT.js";
import {
  Typography_default
} from "./chunk-NHWC7FYV.js";
import {
  Button_default
} from "./chunk-VDIPQ36Y.js";
import {
  IconButton_default
} from "./chunk-3URQJZNI.js";
import "./chunk-PBS3W5LV.js";
import {
  Paper_default
} from "./chunk-ZIENCFC6.js";
import {
  Chip_default
} from "./chunk-AMH3WQFC.js";
import {
  resolveComponentProps_default
} from "./chunk-K2RXEPO6.js";
import {
  refType_default,
  useTimeout
} from "./chunk-DTDDOOU4.js";
...
import {
  useThemeProps
} from "./chunk-HNGMASMZ.js";
import "./chunk-T7IE6CWR.js";
import {
  ownerDocument,
  useControlled
} from "./chunk-OXPKHDKF.js";
import {
  createSvgIcon,
  useEventCallback_default,
  useForkRef
} from "./chunk-QYSKWTHI.js";
import "./chunk-QZNUWM2G.js";
import "./chunk-VIJX77KZ.js";
import "./chunk-DT2PWTUZ.js";
import "./chunk-3JOA4H7Q.js";
import "./chunk-M4WQNFNA.js";
import "./chunk-JZWLJWBD.js";
import {
  alpha,
  capitalize,
  clsx_default,
  ...
  useId,
  useRtl
} from "./chunk-ZKPX2GEV.js";
import {
  require_prop_types
} from "./chunk-EW3POF4D.js";
import {
  _extends
...
var TimeField = React35.forwardRef(function TimeField2(inProps, inRef) {
...
var PickersToolbarText = React36.forwardRef(function PickersToolbarText2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersToolbarText"
  });
...
var PickersToolbarButton = React37.forwardRef(function PickersToolbarButton2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersToolbarButton"
  });
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  const adapter = usePickerAdapter();
  const cleanDate = React40.useMemo(() => !adapter.isValid(date) ? null : date, [adapter, date]);
...
function useTimePickerDefaultizedProps(props, name) {
  ...
  const localeText = React42.useMemo(() => {
    var _a2;
...
var _excluded15 = ["PaperComponent", "ownerState", "children", "paperSlotProps", "paperClasses", "onPaperClick", "onPaperTouchStart"];
...
var PickerPopperPaperWrapper = React43.forwardRef((props, ref) => {
  const {
    PaperComponent,
    ownerState,
    children,
...
function PickerPopper(inProps) {
  ...
  const paperRef = React43.useRef(null);
  ...
  return (0, import_jsx_runtime16.jsx)(Popper, _extends({}, popperProps, {
    children: ({
      TransitionProps
    }) => (0, import_jsx_runtime16.jsx)(FocusTrap, _extends({
      open,
      ...
      children: (0, import_jsx_runtime16.jsx)(Transition, _extends({}, TransitionProps, slotProps == null ? void 0 : slotProps.desktopTransition, {
        ...
        children: (0, import_jsx_runtime16.jsx)(PickerPopperPaperWrapper, {
...
function useViews({
  ...
  const previousOpenTo = React44.useRef(openTo);
  const previousViews = React44.useRef(views);
  const defaultView = React44.useRef(views.includes(openTo) ? openTo : views[0]);
  ...
  const defaultFocusedView = React44.useRef(autoFocus ? view : null);
...
function useValueAndOpenStates(parameters) {
  ...
  } = React46.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React46.useRef(valueProp !== void 0);
  const {
    current: isOpenControlled
  } = React46.useRef(openProp !== void 0);
  const adapter = usePickerAdapter();
  if (true) {
  ...
  const viewValue = React46.useMemo(() => valueManager.cleanValue(adapter, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [adapter, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    current: initialView
  } = React47.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React47.useState(null);
  const popupRef = React47.useRef(null);
  const fieldRef = React47.useRef(null);
  ...
  const {
    ...
    viewModeLookup,
    timeViewsCount
  } = React47.useMemo(() => views.reduce((acc, viewForReduce) => {
  ...
  const [popperView, setPopperView] = React47.useState(currentViewMode === "UI" ? view : null);
  ...
  const ownerState = React47.useMemo(() => ({
  ...
  const triggerStatus = React47.useMemo(() => {
  ...
  const contextValue = React47.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React47.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React47.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
...
true ? PickersActionBarComponent.propTypes = {
   ...
   */
  actions: import_prop_types9.default.arrayOf(import_prop_types9.default.oneOf(["accept", "cancel", "clear", "next", "nextOrAccept", "today"]).isRequired),
  /**
...
var PickersActionBar = React48.memo(PickersActionBarComponent);
if (true)
...
var PickersLayout = React51.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime21.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime21.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime21.jsxs)(React51.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime21.jsxs)(React51.Fragment, {
...
var useDesktopPicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime22.jsxs)(PickerProvider, _extends({}, providerProps, {
    children: [(0, import_jsx_runtime22.jsx)(Field, _extends({}, fieldProps, {
      slots,
      slotProps,
      inputRef
    })), (0, import_jsx_runtime22.jsx)(PickerPopper, {
      slots,
      slotProps,
      children: (0, import_jsx_runtime22.jsx)(Layout, _extends({}, slotProps == null ? void 0 : slotProps.layout, {
        slots,
        slotProps,
...
var _excluded21 = ["children", "className", "slots", "slotProps", "isNextDisabled", "isNextHidden", "onGoToNext", "nextLabel", "isPreviousDisabled", "isPreviousHidden", "onGoToPrevious", "previousLabel", "labelId", "classes"];
...
var PickersArrowSwitcher = React53.forwardRef(function PickersArrowSwitcher2(inProps, ref) {
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersArrowSwitcher"
...
var _excluded26 = ["className", "classes", "isBetweenTwoClockValues", "isInner", "type", "viewValue"];
...
function ClockPointer(inProps) {
  ...
  const previousType = React54.useRef(type);
  React54.useEffect(() => {
  ...
  return (0, import_jsx_runtime24.jsx)(ClockPointerRoot, _extends({
    style: getAngleStyle(),
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: (0, import_jsx_runtime24.jsx)(ClockPointerThumb, {
      ownerState,
...
function Clock(inProps) {
  ...
  const isMoving = React55.useRef(false);
  ...
  return (0, import_jsx_runtime25.jsxs)(ClockRoot, {
    ...
    children: [(0, import_jsx_runtime25.jsxs)(ClockClock, {
      ...
      children: [(0, import_jsx_runtime25.jsx)(ClockSquareMask, {
      ...
      }), !isSelectedTimeDisabled && (0, import_jsx_runtime25.jsxs)(React55.Fragment, {
        children: [(0, import_jsx_runtime25.jsx)(ClockPin, {
          className: classes.pin
        }), value != null && (0, import_jsx_runtime25.jsx)(ClockPointer, {
          type,
          viewValue,
          isInner: isPointerInner,
          isBetweenTwoClockValues: isPointerBetweenTwoClockValues
        })]
      }), (0, import_jsx_runtime25.jsx)(ClockWrapper, {
    ...
    }), ampm && ampmInClock && (0, import_jsx_runtime25.jsxs)(React55.Fragment, {
      children: [(0, import_jsx_runtime25.jsx)(ClockAmButton, {
        onClick: readOnly ? void 0 : () => handleMeridiemChange("am"),
        disabled: disabled || meridiemMode === null,
        ownerState,
        className: classes.amButton,
        title: formatMeridiem(adapter, "am"),
        children: (0, import_jsx_runtime25.jsx)(ClockMeridiemText, {
          variant: "caption",
          className: classes.meridiemText,
          children: formatMeridiem(adapter, "am")
        })
      }), (0, import_jsx_runtime25.jsx)(ClockPmButton, {
        disabled: disabled || meridiemMode === null,
        onClick: readOnly ? void 0 : () => handleMeridiemChange("pm"),
        ownerState,
...
var _excluded27 = ["className", "classes", "disabled", "index", "inner", "label", "selected"];
...
var TimeClock = React59.forwardRef(function TimeClock2(inProps, ref) {
  const adapter = usePickerAdapter();
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimeClock"
  ...
  const isTimeDisabled = React59.useCallback((rawValue, viewType) => {
    const isAfter = createIsAfterIgnoreDatePart(disableIgnoringDatePartForTimeValidation, adapter);
  ...
  const viewProps = React59.useMemo(() => {
    switch (view) {
      case "hours": {
  ...
  return (0, import_jsx_runtime28.jsxs)(TimeClockRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime28.jsx)(Clock, _extends({
      ...
      disabled,
      readOnly
    }, viewProps)), showViewSwitcher && (0, import_jsx_runtime28.jsx)(TimeClockArrowSwitcher, {
...
var DigitalClock = React60.forwardRef(function DigitalClock2(inProps, ref) {
  const adapter = usePickerAdapter();
  ...
  const isTimeDisabled = React60.useCallback((valueToCheck) => {
    const isAfter = createIsAfterIgnoreDatePart(disableIgnoringDatePartForTimeValidation, adapter);
    const containsValidTime = () => {
  ...
  const timeOptions = React60.useMemo(() => {
    const result = [];
  ...
  return (0, import_jsx_runtime29.jsx)(DigitalClockRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: (0, import_jsx_runtime29.jsx)(DigitalClockList, {
      ref: listRef,
      role: "listbox",
      ...
      children: timeOptions.map((option, index) => {
        ...
        return (0, import_jsx_runtime29.jsx)(ClockItem, _extends({
...
var _excluded30 = ["autoFocus", "onChange", "className", "classes", "disabled", "readOnly", "items", "active", "slots", "slotProps", "skipDisabled"];
...
var MultiSectionDigitalClockSection = React61.forwardRef(function MultiSectionDigitalClockSection2(inProps, ref) {
  const containerRef = React61.useRef(null);
  const handleRef = useForkRef(ref, containerRef);
  const previousActive = React61.useRef(null);
  const props = useThemeProps({
    props: inProps,
    name: "MuiMultiSectionDigitalClockSection"
  });
  ...
  return (0, import_jsx_runtime30.jsx)(MultiSectionDigitalClockSectionRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    ...
    children: items.map((option, index) => {
      ...
      return (0, import_jsx_runtime30.jsx)(DigitalClockSectionItem, _extends({
...
var MultiSectionDigitalClock = React62.forwardRef(function MultiSectionDigitalClock2(inProps, ref) {
  ...
  const viewsToRender = React62.useMemo(() => {
    if (!isRtl) {
      return views;
    }
  ...
  return (0, import_jsx_runtime31.jsx)(MultiSectionDigitalClockRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "group"
  }, other, {
    children: viewsToRender.map((timeView) => (0, import_jsx_runtime31.jsx)(MultiSectionDigitalClockSection, {
...
var TimePicker = React68.forwardRef(function TimePicker2(inProps, ref) {
  ...
  if (isDesktop) {
    return (0, import_jsx_runtime35.jsx)(DesktopTimePicker, _extends({
      ref
    }, other));
  }
  return (0, import_jsx_runtime35.jsx)(MobileTimePicker, _extends({
    ref
  }, other));
});
if (true)
